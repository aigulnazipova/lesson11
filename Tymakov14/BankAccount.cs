...
namespace Tymakov14
{
    ...
    [DeveloperAndOrganisationInfo("Aigul Nazipova", "OOO")]
    internal class BankAccount : IDisposable
    {
        ...
        /// Конструктор, который создает новый экземпляр класса и заполняет его данными.
        /// </summary>
        internal BankAccount(decimal balance, BankAccountType type, string name)
        {
            _accountNumber = GenerateAccountNumber();
            this.balance = balance;
            this.type = type;
        ...
        {
            Console.WriteLine($"Баланс: {balance}\nКол-во хранящихся транзакций:{financialTransactions.Count}\n");
        } 
